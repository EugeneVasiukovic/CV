...
![header](https://ic.wampi.ru/2023/04/24/Header_cv.png)

Необходимо удалить в заголовке `MIONSILI`, `BRANDING UNIVERSAL`,`PARSING DESIGN`.

Кнопки выбора языка поставить в центр зоголовка

Изменить `MIONSILI` на фукциональную кнопку `PDF` при нажатии на которую будет скачиваться CV в формате `PDF` , привязать CV к выбраному языку при скачивании.

# Title of the position links to social networks

![ссылки на соц сети должность](https://ie.wampi.ru/2023/04/24/qa_engineer.png)
...
![About us](https://ie.wampi.ru/2023/04/24/ABOUT_US.png)
...
|Имею опыт работы В сфере IT 1 год в качастве специлиста технической поддержки в гибкой среде разработки приложений Desktop/Android в сфере Оптовой и розничной торговли. Отвечаю за постановку задач программистам, консультирование представителей бизнеса по работе ПО и помощь в постановке задач Кураторам бизнеса на доработку ПО, устранение ошибок пользователей, анализ возникших ошибок, написание пользователских инструкций, разработка технической документации по обслуживаемым процессам, в  роботе использую ПО (СУБД MS SQL, Jira, Service Desk, confluence и т.д), В процессе работы с помощью своих навыков снизил количество постпающих обращений от пользователей, тем самым умешил количество поступающих задач разработчикам на 25%. Сейчас получаю опыт в качестве QA engineer частичная занятость в компании ITX, outsourcing company, более детально можно будет ознакомиться с темм, что я делаю в разделе "Опыт".


` Send Message `
можно добавить почту либо убрать кнопку и добавить дополнительное поле .
...
![Education](https://ie.wampi.ru/2023/04/24/education.png)
...
![Awards](https://im.wampi.ru/2023/04/24/AWARDS.png)

Software Quality Assurance Course by Vadim Ksendzov

                            1

пока один сертификат по постману ссылка на него: [https://www.linkedin.com/feed/update/urn:li:activity:7044578089770569728/] отдельно на гугл диске будет лежать сертефикат
...
![HOBBY](https://ie.wampi.ru/2023/04/24/HOBBY.png)

Текст:

Виду активный образ жизни, в свободное время люблю послушать музыку, посмотреть футбол, Посмотреть Блогеров таких как Леша Маршал, Артем Русов, почитать статьи в различных телграмм каналах по QA, повыполнять тз по postman от Надежды Дудник и тд. Читаю статьи по клиент-серверной архитектуре,.
...
![skills](https://im.wampi.ru/2023/04/24/skills.png)

к каждому значкку нужно добавить ссылку, проценты убрать не нужная информация, чек листы сделать один значек вывести две ссылке можно как две кнопоки тип регрессия и Smoke.

- postman [https://github.com/EugeneVasiukovic/postman]

![postman](https://ic.wampi.ru/2023/04/24/Postman.png)

- Terminal Linux [https://github.com/EugeneVasiukovic/terminal)]

![terminal](https://ic.wampi.ru/2023/04/24/terminal.png)

- github [https://github.com/EugeneVasiukovic)]

![git](https://ic.wampi.ru/2023/04/24/git.png)

- PostgresSQL [https://github.com/EugeneVasiukovic/SQL]

![postgressql](https://im.wampi.ru/2023/04/24/postgressql.png)

- чек лист [https://docs.google.com/spreadsheets/d/1QjCIJjgwcOH0L69ZLqYlhkgpXa4bTWgKUOvnAPDMhRQ/edit#gid=812695420]

![cheklist](https://ic.wampi.ru/2023/04/24/cheklist.png)
